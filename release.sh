...
PLATFORMS="$PLATFORMS linux/amd64 linux/armv7 linux/mips64-softfloat linux/mips64le-softfloat openbsd/386"
...
for PLATFORM in ${PLATFORMS}; do
  ...
  [ "x${GOOS}" = "xandroid" ] && prepare_ndk && CGO=1
